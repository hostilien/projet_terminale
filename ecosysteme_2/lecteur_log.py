...
COLOR_FOURMILIERE = (100, 100, 255)     # couleur de la fourmilière
COLOR_FOOD = (150, 0,0)   # couleur de la nourriture
COLOR_FOURMI = (45, 160, 60)     # couleur des fourmis
COLOR_MUR = (255, 255, 255) # couleur des murs
...
def lecture(path_log, path_carte):
    ...
    log_pos_agents, log_pheromones, log_pos_food,  log_charges = read_log(path_log)
